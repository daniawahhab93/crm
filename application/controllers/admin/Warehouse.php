        ...
        if ($this->input->is_ajax_request()) {
            ...
            foreach ($fetch_data as $key => $row) {
                ...
                if (!empty($can_edit) && !empty($edited)) {
                    ...
                    $action .= '<a data-id="' . $row->warehouse_id . '" href="' . base_url('admin/warehouse/make_default/' . $row->warehouse_id) . '" data-toggle="tooltip" title="' . lang('default') . '" class="btn btn-xs btn-success "> ' . lang('default') . ' </a> ' . ' ';
