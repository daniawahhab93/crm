...
<div class="row mb">
            ...
            <ul class="dropdown-menu animated zoomIn">
                <li>
                    <a href="<?= base_url() ?>admin/credit_note/index/email_credit_note/<?= $credit_note_info->credit_note_id ?>"
                        data-toggle="ajaxModal"><?= lang('email_credit_note') ?></a>
                </li>
                <li>
                    <a
                        href="<?= base_url() ?>admin/credit_note/index/credit_note_history/<?= $credit_note_info->credit_note_id ?>"><?= lang('credit_note_history') ?></a>
                </li>
                <li class="<?= $credit_note_info->status == 'open' ? 'hide' : '' ?>">
                    <a
                        href="<?= base_url() ?>admin/credit_note/change_status/open/<?= $credit_note_info->credit_note_id ?>"><?= lang('open') ?></a>
                </li>
                <li class="<?= $credit_note_info->status == 'refund' ? 'hide' : '' ?>">
                    <a
                        href="<?= base_url() ?>admin/credit_note/change_status/refund/<?= $credit_note_info->credit_note_id ?>"><?= lang('refund') ?></a>
                </li>
                <li class="<?= $credit_note_info->status == 'void' ? 'hide' : '' ?>">
                    <a
                        href="<?= base_url() ?>admin/credit_note/change_status/void/<?= $credit_note_info->credit_note_id ?>"><?= lang('void') ?></a>
                </li>
                <?php if (!empty($can_edit) && !empty($edited)) { ?>
                <li class="divider"></li>
                <li>
                    <a
                        href="<?= base_url() ?>admin/credit_note/createcreditnote/edit_credit_note/<?= $credit_note_info->credit_note_id ?>"><?= lang('edit_credit_note') ?></a>
                </li>
                <?php } ?>
    ...
    <div class="col-sm-4 pull-right">
        <a href="<?= base_url() ?>admin/credit_note/send_credit_note_email/<?= $credit_note_info->credit_note_id . '/' . true ?>"
