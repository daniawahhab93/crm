...
<div class="panel panel-custom" id="print_items">
    <header class="panel-heading">
        ...
        <a class="pull-right btn btn-primary btn-xs mr"
            href="<?= base_url('admin/office_items/new_items/' . $items_info->saved_items_id) ?>"><i
                class="fa fa-pencil-square-o"></i></a>
        <?php } ?>
        <?= lang('office_items') . ' ' . lang('details') . ' ' . lang('of') . ' ' . $items_info->item_name ?>
    </header>
            ...
            <div class="col-xs-4">
                ...
                <div id='product-image-wrap'>
                    ...
                    <div class='product-image-thumbnail'><img src='<?php echo $imgaeURL ?>' id='<?= $key + 1 ?>'
                            class='thumb' onclick='preview(this)' alt='<?= $v_files_image->fileName ?>'></div>
                    <?php }
                    } ?>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped ">
                        <tbody>
                            ...
                            <tr>
                                <td class="text-right"><strong><?= lang('unit') ?> : </strong></td>
