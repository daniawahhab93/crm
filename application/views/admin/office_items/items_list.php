...
?>
    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="<?= base_url('admin/office_items/items_list') ?>"><?= lang('all_items') ?></a>
            </li>
            <li class=""><a href="<?= base_url('admin/office_items/new_items') ?>"><?= lang('new_items') ?></a>
            </li>
        </ul>
        <style type="text/css">
            .custom-bulk-button {
                    ...
                    <table class="table table-striped DataTables bulk_table" id="DataTables" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <?php } ?>
                                <th class="col-sm-1"><?= lang('created_date') ?></th>
                        ...
                        <tbody>
                            <script type="text/javascript">
                                $(document).ready(function() {
                                    list = base_url + "admin/office_items/itemsList";
                                    bulk_url = base_url + "admin/office_items/bulk_delete";
                                    ...
                                    $('.filter_by').on('click', function() {
                                        ...
                                        table_url(base_url + "admin/office_items/itemsList/" + filter_by +
                                            search_type);
                                    });
                                });
                            </script>
