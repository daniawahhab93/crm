...
$comment_details = $this->db->where(array('opportunities_id' => $opportunity_details->opportunities_id, 'comments_reply_id' => '0', 'attachments_id' => '0', 'uploaded_files_id' => '0'))->order_by('comment_datetime', 'DESC')->get('tbl_task_comment')->result();
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php
                                ...
                                <span class="btn-xs pull-right">
                                    ...
                                    <a
                                        href="<?= base_url() ?>admin/opportunities/create/<?= $opportunity_details->opportunities_id ?>"><?= lang('edit') . ' ' . lang('opportunities') ?></a>
                                    <?php } ?>
                                </span>
                            </h3>
                        </div>
                    ...
                    <div class="panel panel-custom">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= lang('activities') ?>
                                ...
                                <span class="btn-xs pull-right">
                                    <a
                                        href="<?= base_url() ?>admin/tasks/claer_activities/opportunity/<?= $opportunity_details->opportunities_id ?>"><?= lang('clear') . ' ' . lang('activities') ?></a>
                                </span>
                                <?php } ?>
                            </h3>
                        </div>
                    ...
                    <div class="panel panel-custom">
                        <div class="panel-heading mb0">
                            ...
                            <h3 class="panel-title"><?= lang('attach_file_list') ?>
                                <a data-toggle="tooltip" data-placement="top"
                                    href="<?= base_url('admin/common/download_all_attachment/opportunities_id/' . $opportunity_details->opportunities_id) ?>"
                        ...
                        $(document).ready(function() {
                            $(".toggle-media-view").click(function() {
                                ...
                                $.get('<?= base_url() ?>admin/common/set_media_view/' +
                                    type + '/' + module,
                                    function(response) {});
                            });
                        });
                                    ...
                                    <div class="p pb-sm" role="tab" id="headingOne"
                                        ...
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion"
                                                ...
                                                <strong
                                                    class="text-alpha-inverse"><?php echo $files_info[$key]->title; ?>
                                                </strong>
                                                <small style="color:#ffffff " class="pull-right">
                                                    <?php if ($files_info[$key]->user_id == $this->session->userdata('user_id')) { ?>
                                                    <?php echo ajax_anchor(base_url("admin/opportunities/delete_files/" . $files_info[$key]->attachments_id), "<i class='text-danger fa fa-trash-o'></i>", array("class" => "", "title" => lang('delete'), "data-fade-out-on-success" => "#media_list_container-" . $files_info[$key]->attachments_id)); ?>
                                                    <?php } ?></small>
                                            </a>
                                        </h4>
                                    </div>
                                                        ...
                                                        <tr class="file-item">
                                                            <td data-toggle="tooltip" data-placement="top"
                                                                ...
                                                                <div class="file-icon"><i class="fa fa-file-o"></i>
                                                                    <a data-toggle="modal"
                                                                        data-target="#myModal_extra_lg"
                                                                        href="<?= base_url() ?>admin/opportunities/attachment_details/r/<?= $files_info[$key]->attachments_id . '/' . $v_files->uploaded_files_id ?>"><?= $v_files->file_name ?></a>
                                                                </div>
                                                                <?php endif; ?>
                                                            </td>
                    ...
                    <div class="box" style="border: none; padding-top: 15px;" data-collapsed="0">
                        <div class="nav-tabs-custom">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <?php if (!empty($edited)) { ?>
                                <li class=""><a
                                        href="<?= base_url() ?>admin/tasks/create/opportunities/<?= $opportunity_details->opportunities_id ?>"><?= lang('new_task') ?></a>
                                </li>
                                <?php } ?>
                            </ul>
                            <div class="tab-content bg-white">
                    ...
                    <div class="box" style="border: none; padding-top: 15px;" data-collapsed="0">
                        <div class="nav-tabs-custom">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <?php if (!empty($edited)) { ?>
                                <li class=""><a
                                        href="<?= base_url() ?>admin/bugs/create/opportunities/<?= $opportunity_details->opportunities_id ?>"><?= lang('new_bugs') ?></a>
                                </li>
                                <?php } ?>
                            </ul>
                            <div class="tab-content bg-white">
