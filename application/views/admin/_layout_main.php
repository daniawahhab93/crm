                    ...
                    <div class="pull-right">
                        ...
                        <?php if (!empty($clocking->clock_id)) : ?>
                            <a href="<?php echo base_url() ?>admin/dashboard/set_clocking/<?php
                                                                                            ...
                                                                                            echo '/' . my_id() . '/1';
                                                                                            ?>" class="btn btn-danger clock_button_loc"><i class="fa fa-arrow-left"></i> <?= lang('clock_out') ?></a>
                        <?php else : ?>
                            <a href="<?php echo base_url() ?>admin/dashboard/set_clocking/<?php
                                                                                            if (!empty($clocking)) {
                                                                                                echo $clocking->clock_id;
                                                                                            ...
                                                                                            echo '/' . my_id() . '/1';
                                                                                            ?>" class="btn btn-success clock_button_loc"><i class="fa fa-sign-out"></i> <?= lang('clock_in') ?></a>
                            </button>
                        <?php endif; ?>
