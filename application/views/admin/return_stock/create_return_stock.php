                    ...
                    <div class="col-sm-6 col-xs-12 br pv">
                        <div class="row">
                            ...
                            <div class="form-group" id="border-none">
                                <label for="field-1" class="col-sm-3 control-label"><?= lang('supplier_client') ?>
                                </label>
                                <div class="col-sm-7">
                            ...
                            if ($role == 1) { ?>
                            <div class="form-group">
                                <label   class="col-lg-3 control-label"><?= lang('return_stock_date') ?></label>
                                <div class="col-lg-7">
                                    <div class="input-group">
                                        <input type="text" name="return_stock_date" class="form-control datepicker"
                                            value="<?php if (!empty($return_stock_info->return_stock_date)) {
                            ...
                            <?php }else{?>
                               <label   class="col-lg-3 control-label"><?= lang('return_stock_date') ?></label>
                                <div class="col-lg-7">
                                    <div class="input-group">
                                        <input type="text" name="return_stock_date" readonly class="form-control"
                                            value="<?php if (!empty($return_stock_info->return_stock_date)) {
                                                echo $return_stock_info->return_stock_date;
                                            } else {   echo date('Y-m-d');}  ?>"
                                            data-date-format="<?= config_item('date_picker_format'); ?>">
