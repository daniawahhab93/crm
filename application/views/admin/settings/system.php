            ...
            <section class="panel panel-custom">
                <header class="panel-heading  "><?= lang('system_settings') ?>
                    <div class="pull-right">
                        <button type="submit" class="btn btn-sm btn-primary" style="margin-top: -5px;"><?= lang('save_changes') ?></button>
                    </div>
                </header>
                <div class="panel-body">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= lang('office') . ' ' . lang('location'); ?> <span class="text-danger">*</span></label>
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control inputText2" value="<?= set_value('office_location', config_item('office_location')); ?>" id="searchTextField" name="office_location">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" class="form-control" value="<?= set_value('dist_from_office', config_item('allowed_radius')); ?>" name="allowed_radius" id="dist_from_office">
                            </div>
                        </div>
                        <div class="form-group">
