...
<div class="panel panel-custom">
    <div class="panel-heading">
        ...
        <h4 class="panel-title" id="myModalLabel"><?= $title . '-' . lang('details') ?>
            <a data-toggle="tooltip" data-placement="top" title="<?= lang('download') . ' ' . lang('all') ?>" style="position: absolute;top: 0;right: 30px" href="<?= base_url() ?>admin/tasks/download_all_files/<?= $attachment_info->attachments_id ?>" class="pull-right"><i class="fa fa-2x fa-cloud-download"></i></a>
        </h4>
    </div>
                                    ...
                                    <?php } else { ?>
                                        <div class="no-preview">
                                            <span>
                                                ...
                                                <strong><a style="color: #fff" href="<?= base_url() ?>admin/tasks/download_files/<?= $v_files->uploaded_files_id ?>"> <?= $v_files->file_name ?></a></strong>
                                            </span>

                                            <a href="<?= base_url() ?>admin/tasks/download_files/<?= $v_files->uploaded_files_id ?>" class="pull-right"><i class="fa fa-5x fa-cloud-download"></i></a>
                                        </div>
                                    <?php } ?>
                                <?php } ?>
                                <hr />
