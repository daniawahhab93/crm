                    ...
                    <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
                        <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                <label
                                    class="col-lg-2 control-label"><?=  lang('prefix') ?></label>
                                <div class="col-lg-4">
                                ...
                                <label class="col-lg-2 control-label"><?= lang('company') . '/' . lang('client') ?></label>
                                <div class="col-lg-4">
                                    <input type="text" required
                                        placeholder="<?= lang('enter') . ' ' . lang('company') . '/' . lang('client') . ' ' . lang('for_personal') ?>"
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                            <label for="field-1"
                                   class="col-lg-2  control-label"><?= lang('warehouse') ?></label>
                            <div class="col-lg-4">
                                <div class="input-group">
                                    <?php
                                     $selected ='';
                                     if (!empty($expense_info->warehouse_id)) {
                                           $selected = $expense_info->warehouse_id ;
                                     }


                                    echo form_dropdown('warehouse_id', $warehouseList, $selected, array('class' => 'form-control select_box', 'style' => 'width:100%'));
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-lg-2 control-label"><?= lang('reference_no') ?> </label>
                                <div class="col-lg-4">
