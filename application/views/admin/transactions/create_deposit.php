    ...
    <div class="col-sm-12">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a class="import"
                        href="<?= base_url() ?>admin/transactions/import/Income"><?= lang('import_deposit') ?></a>
                </li>
            </ul>
            <style type="text/css">
            .custom-bulk-button {
                ...
                <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
                    <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form"
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?=  lang('prefix') ?></label>
                            <div class="col-lg-5">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= lang('company') . '/' . lang('client') ?></label>
                            <div class="col-lg-5">
