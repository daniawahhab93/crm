<div class="panel panel-custom">
    <div class="panel-heading">
        ...
        <h4 class="modal-title" id="myModalLabel"><?= lang('training_details') ?>
                            ...
                            ?>
                                        <li>
                                            ...
                                            <div class="mailbox-attachment-info">
                                                <a href="<?= base_url() ?>admin/training/download_file/<?= $training_info->training_id . '/' . $v_files->fileName ?>" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i>
                                                    <?= $v_files->fileName ?></a>
                                                <span class="mailbox-attachment-size">
                                                    <?= $v_files->size ?> <?= lang('kb') ?>
                                                    <a href="<?= base_url() ?>admin/training/download_file/<?= $training_info->training_id . '/' . $v_files->fileName ?>" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                                                </span>
                                            </div>
                                        </li>
                            <?php
