    ...
    <div class="col-md-4">
        <div class="row row-table ">
            ...
            <div class="col-xs-6 pt">
                <div data-sparkline="" data-bar-color="#23b7e5" data-height="60" data-bar-width="8" data-bar-spacing="6"
    ...
    <div class="col-sm-12">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a class="import"
                        href="<?= base_url() ?>admin/client/import"><?= lang('import_clients') ?></a>
                </li>
            </ul>
            <style type="text/css">
            .custom-bulk-button {
...
<!--                                    </li>-->
                                ...
                                <div class="tab-content bg-white">
                                    ...
                                    <div class="chart tab-pane active" id="general_compnay">
                                        ...
                                        <div class="form-group">
                                            <label for="field-1"
                                                class="col-sm-3 control-label"><?= lang('received_sms_notification') ?>
                                                :</label>
