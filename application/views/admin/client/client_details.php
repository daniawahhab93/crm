...
<div class="row mt-lg">
    <div class="col-sm-2">
        <ul class="nav nav-pills nav-stacked navbar-custom-nav">
            ...
            <li class=""><a href="#awardPoint_details" data-toggle="tab" aria-expanded="false"><?= lang('award_point') ?><strong class="pull-right"><?= (!empty($total_bugs) ? $total_bugs : null) ?></strong></a></li>
    ...
    <div class="col-sm-10">
        <div class="tab-content" style="border: 0;padding:0;">
                    ...
                    <div class="panel-heading">
                        <div class="panel-title"><strong><?= $client_details->name ?> - <?= lang('details') ?> </strong>
                            <div class="pull-right">
                                ...
                                if (!empty($edited)) {
                                ?>
                                    <a href="<?php echo base_url() ?>admin/client/create_client/<?= $client_details->client_id ?>" class="btn-xs "><i class="fa fa-edit"></i> <?= lang('edit') ?></a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="panel panel-custom">
                                ...
                                <div class="panel-body">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label"><?= lang('email') ?><span class="text-danger">
                                                    *</span></label>
                                            <div class="col-lg-7">
                                            ...
                                            <div class="col-lg-7">
                                                <select class="  form-control" name="locale">
                                                    <?php foreach ($locales as $loc) : ?>
                                                        <option lang="<?= $loc->code ?>" value="<?= $loc->locale ?>" <?= ($this->config->item('locale') == $loc->locale ? ' selected="selected"' : '') ?>>
                                                            <?= $loc->name ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                    ...
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            <div class="pull-right">
                                ...
                                ?>
                                    <a href="<?= base_url() ?>admin/invoice/createinvoice/create_invoice/c_<?= $client_details->client_id ?>" class="btn btn-purple btn-xs"><?= lang('new_invoice') ?></a>
                                <?php } ?>
                    ...
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            <div class="pull-right">
                                ...
                                ?>
                                    <a href="<?= base_url() ?>admin/estimates/create/edit_estimates/c_<?= $client_details->client_id ?>" class="btn btn-purple btn-xs"><?= lang('new_estimate') ?></a>
                                <?php } ?>
                    ...
                    <div class="panel-body">
                        <table class="table table-striped " cellspacing="0" id="datatable_action" width="100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td><a class="text-info" href="<?= base_url() ?>admin/estimates/create/estimates_details//<?= $estimate->estimates_id ?>"><?= $estimate->reference_no ?></a>
                                            </td>
                ...
                <section class="panel panel-custom">
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            ?>
                                <a href="<?= base_url() ?>admin/projects/create/client_project/<?= $client_details->client_id ?>" class="btn-sm pull-right"><?= lang('new_project') ?></a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="panel-body">
                ...
                <section class="panel panel-custom">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <?= lang('tickets') ?>
                            <?php if (!empty($edited)) { ?>
                                <a href="<?= base_url() ?>admin/tickets/create/edit_tickets/<?= $primary_contact ?>" class="btn-sm pull-right"><?= lang('new_ticket') ?></a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="panel-body">
                ...
                <section class="panel panel-custom">
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            ?>
                                <a href="<?= base_url() ?>admin/bugs/create/<?= $primary_contact ?>" class="btn-sm pull-right"><?= lang('new_bugs') ?></a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="panel-body">
            ...
            <div class="tab-pane" id="awardPoint_details" style="position: relative;">
                <section class="panel panel-custom">
                    <div class="panel-heading">
                        <div class="panel-title">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped DataTables " id="DataTables" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    ?><tr>
                                            <td><a href="<?= base_url('admin/invoice/manage_invoice/invoice_details/' . $v_point['invoices_id']) ?>"><?= $v_point['reference_no'] ?></a></td>
