...
$comment_details = $this->common_model->get_comment_details($id, $comment_type);
?>
<div class="panel panel-custom">
    ...
    <div class="panel-body chat" id="chat-box">
        <?php echo form_open(base_url("admin/common/save_comments"), array("id" => $comment_type . "-comment-form", "class" => "form-horizontal general-form", "enctype" => "multipart/form-data", "role" => "form")); ?>
        
        <input type="hidden" name="module" value="<?php if (!empty($comment_type)) {
            echo $comment_type;
        } ?>">
        ...
        <div class="form-group">
            <div class="col-sm-12">
                ...
                echo form_textarea(array(
                    ...
                    "placeholder" => $name . ' ' . lang('comments'),
        ...
        <hr/>
        <?php echo form_close(); ?>
        <?php $this->load->view('admin/common/comments_list', array('comment_type' => $comment_type,
