...
$comment_details = $this->db->where(array('leads_id' => $leads_details->leads_id, 'comments_reply_id' => '0', 'attachments_id' => '0', 'uploaded_files_id' => '0'))->order_by('comment_datetime', 'DESC')->get('tbl_task_comment')->result();
...
<div class="row mt-lg">
    <div class="col-sm-2">
        ...
        <a href="<?= base_url() ?>admin/leads/create/<?= $leads_details->leads_id ?>" class="btn-xs btn btn-primary"
            title="" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i
        ...
        <a data-toggle="modal" data-target="#myModal_lg"
            ...
            class="btn-xs btn btn-purple pull-right"><i class="fa fa-copy"></i> <?= lang('convert_to_client') ?></a>
        <?php
            }
        }
        ...
        <ul class="<?php
            ...
            <li class="<?= $active == 2 ? 'active' : '' ?>"><a href="#call" data-toggle="tab"><?= lang('call') ?>
            ...
            <li class="<?= $active == 8 ? 'active' : '' ?>"><a href="#tasks" data-toggle="tab"><?= lang('tasks') ?>
    ...
    <div class="col-sm-10">
        ...
        <div class="tab-content" style="border: 0;padding:0;">
                        ...
                        <h3 class="panel-title"><?php
                            ...
                            <span class="btn-xs pull-right">
                                ...
                                if ($leads_details->converted_client_id == 0) {
                                    if (!empty($can_edit) && !empty($edited)) { ?>
                                <a
                                    href="<?= base_url() ?>admin/leads/create/<?= $leads_details->leads_id ?>"><?= lang('edit') . ' ' . lang('leads') ?></a>
                                <?php }
                                } else {
                                ...
                                <div class="col-sm-1 pull-right mt">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu animated zoomIn">
                                            ...
                                            <li>
                                                <a
                                                    href="<?= base_url() ?>admin/leads/change_status/<?= $leads_details->leads_id ?>/<?= $v_status->lead_status_id ?>"><?= lang($v_status->lead_type) . '-' . $v_status->lead_status ?></a>
                                            </li>
                                            <?php
                                                        }
                                                    }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="input-group">
                                            <input type="text" required="" name="date" class="form-control datepicker"
                                                value="<?php
            ...
            <!-- Task Comments Panel Ends--->
            <div class="tab-pane <?= $active == 11 ? 'active' : '' ?>" id="task_notes" style="position: relative;">
                <div class="panel panel-custom">
                    <div class="panel-heading">
                    ...
                    <div class="panel-body">
                                    ...
                                    <div class="checkbox c-checkbox">
                                        <label class="needsclick">
                                            ...
                                            <input type="checkbox" value="touch_with_leads" data-result="show"
                                                name="contacted_indicator" class="select_one hideshow">
                                    ...
                                    <div class="checkbox c-checkbox">
                                        <label class="needsclick">
                                            ...
                                            <input type="checkbox" <?php
                                                                    ...
                                                                    ?> class="select_one hideshow" data-result="hide"
                                                value="not_contacted" name="contacted_indicator">
                                            <span class="fa fa-check"></span>
                        ...
                        <div class="mb-mails col-sm-12" id="leads_notes_<?php $v_notes->notes_id ?>">
                            ...
                            <div class="mb-mail-date pull-right">
                                ...
                                <?php } ?>
                                <?= time_ago($v_notes->created_time) ?> <strong data-toggle="tooltip"
                                    data-placement="top" style="cursor:pointer" class="" title=""
                                    ...
                                    data-original-title="Delete"><i class="text-danger fa fa-trash-o"></i></strong>
                            </div>
                    ...
                    <div class="panel-heading mb0">
                        ...
                        <h3 class="panel-title"><?= lang('attach_file_list') ?>
                            ...
                            <a data-toggle="tooltip" data-placement="top"
                                href="<?= base_url('admin/common/download_all_attachment/leads_id/' . $leads_details->leads_id) ?>"
                                    ...
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $key ?>"
                                            ...
                                            <small style="color:#ffffff " class="pull-right">
                                                ...
                                                <?php echo ajax_anchor(base_url("admin/leads/delete_files/" . $files_info[$key]->attachments_id), "<i class='text-danger fa fa-trash-o'></i>", array("class" => "", "title" => lang('delete'), "data-fade-out-on-success" => "#media_list_container-" . $files_info[$key]->attachments_id)); ?>
                                                <?php } ?></small>
                                        </a>
                                    </h4>
                                </div>
                                                        ...
                                                        <td data-toggle="tooltip" data-placement="top"
                                                            ...
                                                            <div class="file-icon"><i class="fa fa-file-o"></i>
                                                                <a data-toggle="modal" data-target="#myModal_extra_lg"
                                                                    href="<?= base_url() ?>admin/leads/attachment_details/r/<?= $files_info[$key]->attachments_id . '/' . $v_files->uploaded_files_id ?>"><?= $v_files->file_name ?></a>
                                                            </div>
                                                            <?php endif; ?>
                                                        </td>
                    ...
                    <div class="panel panel-custom">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?= lang('activities') ?>
                                ...
                                <span class="btn-xs pull-right">
                                    <a
                                        href="<?= base_url() ?>admin/tasks/claer_activities/leads/<?= $leads_details->leads_id ?>"><?= lang('clear') . ' ' . lang('activities') ?></a>
                                </span>
                                <?php } ?>
                            </h3>
                        </div>
            ...
            <div class="tab-pane <?= $active == 8 ? 'active' : '' ?>" id="tasks" style="position: relative;">
                <div class="nav-tabs-custom ">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <?php if (!empty($edited)) { ?>
                        <li class=""><a
                                href="<?= base_url() ?>admin/tasks/create/leads/<?= $leads_details->leads_id ?>"><?= lang('new_task') ?></a>
                        </li>
                        <?php } ?>
                    </ul>
                    <div class="tab-content bg-white">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu animated zoomIn">
                                                                <li>
                                                                    <a
                                                                        href="<?= base_url() ?>admin/proposals/index/email_proposals/<?= $v_proposals->proposals_id ?>"><?= lang('send_email') ?></a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="<?= base_url() ?>admin/proposals/index/proposals_details/<?= $v_proposals->proposals_id ?>"><?= lang('view_details') ?></a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="<?= base_url() ?>admin/proposals/index/proposals_history/<?= $v_proposals->proposals_id ?>"><?= lang('history') ?></a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="<?= base_url() ?>admin/proposals/change_status/declined/<?= $v_proposals->proposals_id ?>"><?= lang('declined') ?></a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="<?= base_url() ?>admin/proposals/change_status/accepted/<?= $v_proposals->proposals_id ?>"><?= lang('accepted') ?></a>
                                                                </li>
