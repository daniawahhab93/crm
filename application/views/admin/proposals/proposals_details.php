    ...
    <div class="col-sm-8">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu animated zoomIn">
                ...
                <li>
                    <a data-toggle="modal" data-target="#myModal_large"
                        href="<?= base_url() ?>admin/proposals/convert_to/estimate/<?= $proposals_info->proposals_id ?>">
<!--                        --><?//= lang('estimate') ?>
                    </a>
                </li>
            </ul>
        ...
        <?php } else {
                    if ($proposals_info->convert_module == 'invoice') {
                        ...
                        $c_url = base_url() . 'admin/estimates/create/estimates_details/' . $proposals_info->convert_module_id;
                    } ?>
        <?php } ?>
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu animated zoomIn">
                ...
                <li>
                    <a
                        href="<?= base_url() ?>admin/proposals/index/proposals_history/<?= $proposals_info->proposals_id ?>"><?= lang('proposal_history') ?></a>
                </li>
                <li>
                ...
                <li>
                    <a
                        href="<?= base_url() ?>admin/proposals/change_status/declined/<?= $proposals_info->proposals_id ?>"><?= lang('declined') ?></a>
                </li>
                <li>
                    <a
                        href="<?= base_url() ?>admin/proposals/change_status/accepted/<?= $proposals_info->proposals_id ?>"><?= lang('accepted') ?></a>
                </li>
                <?php if (!empty($can_edit) && !empty($edited)) { ?>
                <li class="divider"></li>
                <li>
                    <a
                        href="<?= base_url() ?>admin/proposals/createproposal/edit_proposals/<?= $proposals_info->proposals_id ?>"><?= lang('edit') . ' ' . lang('proposals') ?></a>
                </li>
                <?php } ?>
            </ul>
        </div>
    ...
    <div class="col-sm-4 pull-right">
        <a href="<?= base_url() ?>admin/proposals/send_proposals_email/<?= $proposals_info->proposals_id . '/' . true ?>"
        ...
        <a href="<?= base_url() ?>admin/proposals/pdf_proposals/<?= $proposals_info->proposals_id ?>"
