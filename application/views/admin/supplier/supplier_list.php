...
<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?= base_url('admin/supplier/') ?>"><?= lang('supplier_list') ?></a>
        </li>
        <li class=""><a
                href="<?= base_url('admin/supplier/create_supplier') ?>"><?= lang('new_supplier') ?></a>
        </li>
        ...
        <div class="tab-pane active" id="manage">
            ...
            <div class="panel panel-custom">
                <header class="panel-heading ">
                    <div class="panel-title"><strong><?= lang('supplier_list') ?></strong></div>
                </header>
                <?php } ?>
