...
<?php if (!empty($created) || !empty($edited)) { ?>
    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="<?= base_url('admin/warehouse/manage') ?>"><?=  lang('warehouses') ?></a>
            </li>

            <li class=""><a href="<?= base_url('admin/warehouse/create') ?>"><?= lang('new_warehouse') ?></a></li>
        ...
        <?php } else { ?>
            <div class="panel panel-custom">
                <header class="panel-heading ">
                    <div class="panel-title"><strong><?= lang('all_warehouses') ?></strong></div>
                </header>
            <?php } ?>
