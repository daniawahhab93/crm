<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        <li class=""><a href="<?= base_url('admin/warehouse/manage') ?>"><?=  lang('warehouses') ?></a></li>
        <li class="active"><a href="<?= base_url('admin/warehouse/create') ?>"><?= lang('new_warehouse') ?></a></li>
    </ul>
    <div class="tab-content bg-white">
        <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form" action="<?= base_url('admin/warehouse/save_warehouse/' . (!empty($warehouse_info) ? $warehouse_info->warehouse_id : '0') . '/' . $inline); ?>" method="post" class="form-horizontal  <?= (!empty($inline) ? 'myInline' : '') ?> ">

            <div class="form-group">
                <label class="col-lg-3 control-label"><?= lang('warehouse_code') ?> <span class="text-danger">*</span></label>
                <div class="col-lg-5">
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label"><?= lang('warehouse_name') ?> <span class="text-danger">*</span></label>
                <div class="col-lg-5">
                    <input type="text" class="form-control" value="<?php
                                                                    if (!empty($warehouse_info)) {
                        ...
                        <div>
                            <span class="btn btn-default btn-file">
                                <span class="fileinput-new">
                                    <input type="file" name="image" value="upload" data-buttonText="<?= lang('choose_file') ?>" id="myImg" />
                ...
                <div class="col-sm-8">
                    <div class="col-sm-4 row">
                        <div class="checkbox-inline c-checkbox">
                            <label>
                                <input <?= (!empty($warehouse_info->status) && $warehouse_info->status == 'published' ? 'checked' : ''); ?> class="select_one" type="checkbox" name="status" value="published">
                    ...
                    <div class="col-sm-4">
                        <div class="checkbox-inline c-checkbox">
                            <label>
                                <input <?= (!empty($warehouse_info->status) && $warehouse_info->status == 'unpublished' ? 'checked' : ''); ?> class="select_one" type="checkbox" name="status" value="unpublished">
