                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-addon"
                                                title="<?= lang('new_client') ?>" data-toggle="tooltip"
                                                data-placement="top">
...
<!--                            <div class="form-group">-->
<!--                                <label class="col-lg-3 control-label">--><?php //echo lang('project') ?><!--</label>-->
<!--                                <div class="col-lg-7">-->
...
//                                            ?>
<!--                                        <option value="--><?php //echo $v_project->project_id ?><!--" --><?php
//                                                                                                        if (!empty($project_id)) {
//                                                                                                            echo $v_project->project_id == $project_id ? 'selected' : '';
//                                                                                                        }
//                                                                                                        ?>
<!--                            >-->
<!--                                            --><?php //echo $v_project->project_name ?><!--</option>-->
<!--                                        --><?php
//                                                    }
//                                                }
//                                            }
