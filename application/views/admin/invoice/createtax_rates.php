...
<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class=""><a href="<?= base_url('admin/invoice/tax_rates') ?>"><?= lang('tax') ?></a>
        </li>
            ...
            <form method="post" data-parsley-validate="" novalidate=""
                ...
                <div class="btn-bottom-toolbar text-right">
                    ...
                    <button type="submit" name="save" value="2"
                        class="btn btn-sm btn-warning "><?php echo !empty($tax_rates_info->tax_rate_name) ? lang('update_and_add_more') : lang('save_and_add_more') ?></button>
                </div>
            </form>
            <?php } else { ?>
        </div>
