<div class="panel panel-custom">
    ...
    <div class="modal-body wrap-modal wrap">
        <form role="form" id="from_items"
              action="<?php echo base_url(); ?>admin/invoice/export_to_excel/<?= $module ?>" method="post"
              class="form-horizontal form-groups-bordered">

            <input name="invoices_ids" type="text" hidden>
            <div class="form-group">
                ...
                <div class="col-lg-7">
                    <?php
                    if ($module == 'invoice') {
                        $invoiceFilterExcel = $this->invoice_model->get_invoice_fields_for_excel();
                    }
                    //                    if ($module == 'estimate') {
                    ...
                    //                    }
                    if (!empty($invoiceFilterExcel)) {
                        foreach ($invoiceFilterExcel as $e_Filter) { ?>
                            <label class="radio c-radio">
                                <input  type="checkbox" name="invoice_field_<?php echo $e_Filter['value'] ?>"
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#from_items").submit(function (e) {
            ...
            $("input[name='invoices_ids']").val(join_selected_values);
        });
