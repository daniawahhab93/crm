                            ...
                            <ul class="dropdown-menu dropdown-menu-left from_account" style="">
                                ...
                                if (!empty($all_project)) {
                                    foreach ($all_project as $v_project) {
                                        ?>
                                        <li class="filter_by" id="<?php echo $v_project->project_id ?>"
                        ...
                        <div class="row mb-lg invoice accounting-template">
                            <div class="col-sm-6 col-xs-12 br pv">
                                <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="input-group">
                                                    <select class="form-control select_box" style="width: 100%"
                                                            name="client_id"  id="client_id" onchange="get_project_by_id(this.value)"
                                                            required="">
                                                        <option value="">
                                    ...
                                    ?>
                                    <!--                                                            <option value="-->
                                    <?php //echo $v_cproject->project_id ?><!--" --><?php
                                    //                                                            if (!empty($project_id)) {
                                    //                                                                echo $v_cproject->project_id == $project_id ? 'selected' : '';
                                    //                                                            }
                                    ?>
                                    <!--                                                            >-->
                                    <!--                                                                --><?php //echo $v_cproject->project_name ?>
                                    <!--                                                            </option>-->
                                    <?php
                                    //                                                        }
                                    //                                                    }
                                    ...
                                    <?php }else{?>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="input-group">
                                                    <input type="text" name="invoice_date" readonly class="form-control"
                                                           value="<?php
                                                           if (!empty($invoice_info->invoice_date)) {
                                                               echo $invoice_info->invoice_date;
                                                           } else {
                            ...
                            <div class="col-sm-6 col-xs-12 br pv">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label"><?= lang('notes') ?> </label>
                                        <div class="col-sm-7">
                                    ...
                                    <?php if (!empty($project_id)) : ?>
                                        <div class="form-group">
                                            <label for="field-1"
                                                   class="col-sm-4 control-label"><?php echo lang('visible_to_client') ?>
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                ?> data-on="<?php echo lang('yes') ?>"
                                                       data-off="<?php echo lang('no') ?>"
