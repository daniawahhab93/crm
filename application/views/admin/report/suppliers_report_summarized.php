    ...
    <div class="hidden-print">
        <div class="criteria-band">
            <address class="row" style="margin: 2px;">
                <?php echo form_open(base_url() . 'admin/report/suppliers_report_summarized'); ?>
        ...
        <div class="panel-body table-responsive">
            <table class="table zi-table table-hover norow-action small">
                ...
                <tr>
                    ...
                    <th class="text-left">
                        <div class="pull-left "> <?= lang('total') . ' ' . lang('purchase_amount') ?></div>
                    </th>
                    <th class="text-left">
                        <div class="pull-left "> <?= lang('total') . ' ' . lang('tax') . ' ' . lang('amount') ?></div>
                    </th>
                    <th class="text-left">
                        <div class="pull-left "> <?= lang('total') . ' ' . lang('balance_due') ?></div>
                    </th>
                ...
                $purchase_total = 0;
                $total_tax = 0;
                $first = reset($all_purchases);
                $last = end($all_purchases);
                if ($first && $last && $last->purchase_date < $first->purchase_date) {
                    $first = end($all_purchases);
                    $last = reset($all_purchases);
                }
                if (!empty($all_purchases)) {
                    ...
                    <tr>
                        <td><?= $first->purchase_date ?></td>
                        <td><?= $last->purchase_date ?></td>
                        <td><?= display_money($purchase_total, $cur->symbol) ?></td>
