            ...
            <div class="pull-right">
                <div class="btn-group ">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="<?= base_url() ?>admin/report/sales_report/sales_report_details"><?= lang('sales_report_details') ?></a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/report/sales_report/sales_report_summarized"><?= lang('sales_report_summarized') ?></a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/report/sales_report/sales_analytics_report"><?= lang('sales_analytics_report') ?></a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/report/sales_report/sales_profit_report"><?= lang('sales_profit_report') ?></a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/report/sales_report/wasted_items"><?= lang('wasted_items_report') ?></a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/report/sales_report/return_stock_items"><?= lang('return_stock_items_report') ?></a>
                        </li>
                        <li>
                ...
                if (!empty($filterBy)) {
                    ...
                    <?php if(is_array($status)){  ?>
                        <a data-toggle="tooltip" data-placement="top"
                           href="<?= base_url() ?>admin/report/sales_report_pdf/<?= $filterBy . '/' . $status['value'] . '/' . implode('/', $range) ?>"
                           title="<?= lang('pdf') ?>"
        ...
        <div class="panel-body table-responsive">
            ...
            if (!empty($filterBy)) {
                if ($filterBy == 'invoices'){
                    ...
                    $this->load->view('admin/report/sales_report_details');
                }elseif ( $filterBy == 'sales_report_summarized') {
                    $this->load->view('admin/report/sales_report_summarized');
                }elseif ( $filterBy == 'sales_analytics_report') {
                    $this->load->view('admin/report/sales_analytics_report');
                }elseif ( $filterBy == 'sales_profit_report') {
                    $this->load->view('admin/report/sales_profit_report');
                }elseif ($filterBy == 'payments') {
                    $this->load->view('admin/report/payment_reports');
                } elseif ($filterBy == 'wasted_items') {
                    $this->load->view('admin/report/wasted_items_reports');
                }  elseif ($filterBy == 'return_stock_items') {
                    $this->load->view('admin/report/return_stock_items_reports');
