    ...
    <div class="hidden-print">
        <div class="criteria-band">
            <address class="row">
                            ...
                            if (!empty($all_client)) {
                                foreach ($all_client as $v_client) {
                                    ...
                                    <option value="<?= $v_client->client_id ?>"
                                        ...
                                        ?>
                                    ><?= ucfirst($v_client->name).' : '.$v_client->mobile ?></option>
                                    <?php
                                }
                            }
                            ?>
                ...
                <?php }
                elseif ($filterBy == 'invoice_by_warehouse') {  ?>
                    <div class="col-md-3">
                            ...
                            if (!empty($all_warehouse)) {
                                foreach ($all_warehouse as $v_warehouse) {
                                    ...
                                    <option value="<?= $v_warehouse->warehouse_id ?>"
                                        <?php
                                        if (!empty($status)) {
                                            echo $status == $v_warehouse->warehouse_id ? 'selected' : null;
                                        }
                                        ?>
                ...
                <?php } elseif ($filterBy == 'invoice_by_item') {  ?>
                    <div class="col-md-3">
                            ...
                            if (!empty($all_item)) {
                                foreach ($all_item as $v_item) {
                                    ...
                                    <option value="<?= $v_item->saved_items_id  ?>"
                                        <?php
                                        if (!empty($status)) {
                                            echo $status == $v_item->saved_items_id  ? 'selected' : null;
                                        }
                                        ?>
