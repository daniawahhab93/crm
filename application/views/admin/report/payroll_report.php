        ...
        <div class="panel panel-custom"><!-- *********     Employee Search Panel ***************** -->
            <div class="panel-heading">
                <div class="panel-title">
                    <strong><?= lang('payroll_report') ?></strong>
                </div>
            </div>
            <form id="form" role="form" enctype="multipart/form-data"
                  action="<?php echo base_url() ?>admin/report/payroll_report" method="post"
        ...
        <table class="table table-striped " id="DataTables" cellspacing="0" width="100%">
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    list = base_url + "admin/report/payment_historyList/<?= $pdf ?>";
                    <?php }?>

                    <?php if($search_type == 'month'){?>
                    list = base_url + "admin/report/payment_historyMonth/<?= $pdf ?>";
                    <?php }?>
                });
            </script>
                ...
                foreach ($employee_payroll as $index => $v_payroll) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $ratio=$v_employee->ratio_on_sale;
                            $total_with_ratio= $total_invoice*$ratio/100;
                            ?>
                            <?= display_money($total_with_ratio, $currency->symbol) ?>
                        </td>

                        <td class="hidden-print">
                            <a href="<?php echo base_url() ?>admin/report/salary_payment_details/<?php echo $v_payroll->salary_payment_id ?>"
