                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <?php if (timer_status('projects', $project_details->project_id, 'on')) { ?>
                                                    ...
                                                    <a class="btn btn-xs btn-danger " href="<?= base_url() ?>admin/projects/tasks_timer/off/<?= $project_details->project_id ?>"><?= lang('stop_timer') ?>
                                                    </a>
                                                <?php } else {
                                                ?>
                                                    ...
                                                    if (!empty($this_permission)) { ?>
                                                        <a class="btn btn-xs btn-success <?= $disabled ?>" href="<?= base_url() ?>admin/projects/tasks_timer/on/<?= $project_details->project_id ?>"><?= lang('start_timer') ?>
                                                        </a>
                                                <?php }
                                                }
                                                ?>
                                ...
                                <div class="col-sm-8 " style="margin-left: -5px;">
                                    ...
                                    <span class="">
                                        <div class="mt progress progress-striped ">
                                            <div class="progress-bar <?= $progress_b ?> " data-toggle="tooltip" data-original-title="<?= $progress ?>%" style="width: <?= $progress ?>%">
                                            </div>
                                        </div>
                                    </span>
                                </div>
                ...
                $(document).ready(function() {
                    ...
                    var projectFilesDropzone = new Dropzone("#comments_file-dropzone", {
                        ...
                        success: function(file) {
                            setTimeout(function() {
                                $(file.previewElement).find(".progress-striped").removeClass(
                                    "progress-striped").addClass("progress-bar-success");
                            }, 1000);
                        }
                    });
                                                ...
                                                <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $key ?>" aria-expanded="true" aria-controls="collapseOne">
                                                    ...
                                                    <small style="color:#ffffff " class="pull-right">
                                                        <?php if ($files_info[$key]->user_id == $this->session->userdata('user_id')) { ?>
                                                            <?php echo ajax_anchor(base_url("admin/projects/delete_files/" . $files_info[$key]->attachments_id), "<i class='text-danger fa fa-trash-o'></i>", array("class" => "", "title" => lang('delete'), "data-fade-out-on-success" => "#media_list_container-" . $files_info[$key]->attachments_id)); ?>
                                                        <?php } ?></small>
                                                </a>
                                            </h4>
                                        </div>
                                                                    ...
                                                                    <tr class="file-item">
                                                                        <td data-toggle="tooltip" data-placement="top" data-original-title="<?= $files_info[$key]->description ?>">
                                                                            <?php if ($v_files->is_image == 1) : ?>
                                                                                <div class="file-icon"><a data-toggle="modal" data-target="#myModal_extra_lg" href="<?= base_url() ?>admin/projects/attachment_details/r/<?= $files_info[$key]->attachments_id . '/' . $v_files->uploaded_files_id ?>">
                                                                                        <img style="width: 50px;border-radius: 5px;" src="<?= base_url() . $v_files->files ?>" /></a>
                                                                                </div>
                                                                            <?php else : ?>
                                                                                <div class="file-icon"><i class="fa fa-file-o"></i>
                                                                                    <a data-toggle="modal" data-target="#myModal_extra_lg" href="<?= base_url() ?>admin/projects/attachment_details/r/<?= $files_info[$key]->attachments_id . '/' . $v_files->uploaded_files_id ?>"><?= $v_files->file_name ?></a>
                                                                                </div>
                                                                            <?php endif; ?>
                                                                        </td>
                ...
                <div class="box" style="border: none; " data-collapsed="0">
                    ...
                    <?php } else { ?>
                        <div class="panel panel-custom">
                            <!-- Tabs within a box -->
                            <ul class="nav nav-tabs">
                                <li class="<?= $miles_active == 1 ? 'active' : ''; ?>"><a href="#manage_milestone"><?= lang('milestones') ?></a>
                                </li>
                                <?php if (!empty($edited)) { ?>
                                    <li class="<?= $miles_active == 2 ? 'active' : ''; ?>"><a href="#create_milestone"><?= lang('add_milestone') ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
                            <div class="tab-content bg-white">
