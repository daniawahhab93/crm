        ...
        <div class="col-sm-12">
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="<?= $active == 1 ? 'active' : ''; ?>"><a href="<?= base_url('admin/projects') ?>"><?= lang('all') . ' ' . lang($tab) ?></a>
                    </li>

                    <li class="<?= $active == 2 ? 'active' : ''; ?>"><a href="<?= base_url('admin/projects/create') ?>"><?= lang('new_project') ?></a>
                    </li>
                    <li><a class="import" href="<?= base_url() ?>admin/projects/import"><?= lang('import') . ' ' . lang('project') ?></a>
                    </li>
                </ul>
                <div class="tab-content bg-white">
                    <!-- ************** general *************-->
                    <div class="tab-pane <?= $active == 1 || $active == 'overdue' || $active == 'started' || $active == 'on_hold' || $active == 'in_progress' || $active == 'cancel' || $active == 'completed' ? 'active' : ''; ?>" id="manage">
                    <?php } else { ?>
                        <style type="text/css">
                            .pull-right a {
                                font-size: 14px;
