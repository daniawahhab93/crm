                        ...
                        <div class="panel panel-custom">
                            ...
                            <div class="panel-body">
                                <?php
                                    ...
                                    ?>
                                <div class="">
                                    <label class="col-sm-6 control-label"><strong><?php echo lang($v_allowance->salary_payment_allowance_label) ?>
                                            : </strong></label>
                                    <p class="form-control-static"><?php
                        ...
                        <div class="panel panel-custom">
                            ...
                            <div class="panel-body">
                                <?php
                                    ...
                                    ?>
                                <div class="">
                                    <label class="col-sm-6 control-label"><strong><?php echo lang($v_deduction->salary_payment_deduction_label); ?>
                                            : </strong></label>
                                    <p class="form-control-static"><?php
