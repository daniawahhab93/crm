    ...
    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs">
            <li class="<?= $active == 1 ? 'active' : ''; ?>"><a
                        href="<?= base_url('admin/attendance/workplace') ?>"><?= lang('manage_workplace') ?></a></li>
            <li class="<?= $active == 2 ? 'active' : ''; ?>"><a
                        href="<?= base_url('admin/attendance/new_workplace') ?>"><?= lang('new_workplace') ?></a></li>
        </ul>
        <div class="tab-content bg-white">
            ...
            <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
                ...
                <div class="form-group">
                    <label class="col-lg-3 col-md-3 col-sm-4 control-label"><?= lang('name') ?> <span
                ...
                <div class="form-group">
                    <label class="col-lg-3 col-md-3 col-sm-4 control-label"><?= lang('workplace_details') ?> <span
                                class="text-danger">*</span></label>
                    <div class="col-lg-6 col-md-6 col-sm-7">
                        <textarea class="form-control" name="workplace_details" required=""><?php
                            if (!empty($workplace_info)) {
                                echo $workplace_info->workplace_details;
                            }
                            ?>
                        </textarea>
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label"><?= lang('workplace') . ' ' . lang('location'); ?> <span
                                class="text-danger">*</span></label>
                    <div class="col-lg-6">
                        <div class="input-group">
                            <input type="text" class="form-control inputText2"
                                   value="<?= set_value('workplace_location', config_item('workplace_location')); ?>"
                ...
                <input type="hidden" class="form-control" value="<?= set_value('lat', config_item('office_lat')); ?>"
                       name="office_lat" id="lat">
                <input type="hidden" class="form-control" value="<?= set_value('long', config_item('office_long')); ?>"
                       name="office_long" id="long">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="by_employee form-control selectpicker" id="teamPositionFilter"
                                data-live-search="true" multiple style="width: 100%" name="user_id[]">
                            <?php
                                    ...
                                    <optgroup label="<?php echo $dept_name; ?>">
                                        <?php if (!empty($v_all_employee)) : foreach ($v_all_employee as $v_employee) : ?>
                                            ...
                                            if (!empty($workplace_info->user_id)) {
                                                $userID = json_decode($workplace_info->user_id);
