<div class="panel panel-custom">
    ...
    <div class="modal-body wrap-modal wrap ui-front">
        ...
        <form role="form" id="from_items" data-parsley-validate="" novalidate="" action="<?php echo base_url(); ?>admin/estimates/converted/<?= $estimates_info->estimates_id ?>" method="post" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="row">
                        ...
                        <div class="f_client_id">
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <select class="form-control select_box  ajax-search" required style="width: 100%" name="client_id" onchange="get_project_by_id(this.value)">
            ...
            if (!empty($estimates_info)) {
                ...
                $pdata['warehouseId'] = $estimates_info->warehouse_id;
            }
