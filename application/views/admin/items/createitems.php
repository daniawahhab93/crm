...
<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class=""><a href="<?= base_url('admin/items/newitems_group') ?>"><?= lang('group_list') ?></a>
        </li>


        <li class=""><a
                    href="<?= base_url('admin/items/items_manufacturerlist') ?>"><?= lang('manufacturer_list') ?></a>
        </li>
        <li><a class="import" href="<?= base_url() ?>admin/items/import"><?= lang('import_items') ?></a>
        </li>
    </ul>
    <style type="text/css">
        .custom-bulk-button {
        ...
        <div class="tab-pane active" id="create">
            <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form"
                ...
                <div class="col-sm-7">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 col-md-3 col-sm-3 control-label"><?= lang('code') ?></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->code;
                            }
                            ?>" name="code" placeholder="<?= lang('item_code_help') ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 col-md-3 col-sm-3 control-label"><?= lang('old_code') ?></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->old_code;
                            }
                            ?>" name="old_code" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 col-md-3 col-sm-3 control-label"><?= lang('minimum_in_stock') ?></label>
                        <div class="col-lg-9">
                            <input type="text" min=0 class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->minimum_in_stock;
                            }
                            ?>" name="minimum_in_stock" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                <?php
                                $selected = ($items_info->manufacturer_id) ? $items_info->manufacturer_id : '';
                                echo form_dropdown('manufacturer_id', $all_manufacturer, $selected, array('class' => 'form-control select_box', 'style' => 'width:100%'));
                                ?>
                                <div class="input-group-addon" title="<?= lang('new_manufacturer') ?>"
                    ...
                    <?php if (empty($items_info)) { ?>
                        <div class="form-group">
                            <label for="field-1"
                                   class="col-sm-3 col-md-3 col-sm-3 control-label"><?= lang('select_warehouse') ?><span
                                        class="text-danger">*</span></label>
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <?php
                                    $warehouseList['all'] = lang('all');

                                    $selected = ($items_info->warehouse_id) ? $items_info->warehouse_id : 'all';
                                    ...
                                    ?>
                                    <div class="input-group-addon" title="<?= lang('new_warehouse') ?>"
                                         data-toggle="tooltip" data-placement="top">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('unit') ?></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('quantity_to_change_price') ?> <span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <input type="text" data-parsley-type="number" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->quantity_to_change_price;
                            }
                            ?>" name="quantity_to_change_price" required="">
                        </div>

                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('price_increase_rate') ?> <span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <input type="text" data-parsley-type="number" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->price_increase_rate;
                            }
                            ?>" name="price_increase_rate" required=""> %
                        </div>

                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('item_group') ?> </label>
                        <div class="col-lg-9">
                            <div class="input-group">
                                <?php
                                $selected = ($items_info->customer_group_id) ? $items_info->customer_group_id : '';
                                echo form_dropdown('customer_group_id', $all_customer_group, $selected, array('class' => 'form-control select_box', 'style' => 'width:100%'));
                                ?>
                                <div class="input-group-addon" title="<?= lang('new_item_group') ?>"
                                     data-toggle="tooltip" data-placement="top">
                                    <a data-toggle="modal" data-target="#myModal"
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('alternative_items') ?></label>
                        <div class="col-lg-9">
                            <select name='alternative_items[]' class="form-control selectpicker" data-live-search="true"
                                    multiple>
                                <?php foreach ($alternativeItems as $a_i) {
                                    ?>
                                    <?php $selected = '';
                                    if ($items_info->alternative_items != null)
                                        $alternativeItemsArray=json_decode($items_info->alternative_items,true);
                                    if($alternativeItemsArray && in_array($a_i->saved_items_id,$alternativeItemsArray))
                                        $selected='selected';
                                        ?>
                                    <option value='<?php echo $a_i->saved_items_id ?>' <?php echo $selected?>><?php echo $a_i->item_name ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
