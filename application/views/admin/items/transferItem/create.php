                    ...
                    <div class="col-sm-6 col-xs-12 br pv">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        ...
                                        ?>
                                        <div class="input-group-addon"
                                            title="<?= lang('new_warehouse') ?>" data-toggle="tooltip"
                                            data-placement="top">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <?php
                                    $status = array('pending' => lang('pending'), 'completed' => lang('completed'), 'send' => lang('sended'), 'approved' => lang('approved'), 'rejected' => lang('rejected'));
                            ...
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label"><?= lang('source_type') ?></label>

                                <div class="col-sm-4">
                                    <?php

                                    $source_type = array('without' => lang('without'), 'purchase invoice' => lang('purchase invoice'), 'warehouse orders' => lang('warehouse orders'),);

                                    $selected = ($items_info->source_type) ? $items_info->source_type : '';
                                    echo form_dropdown('source_type', $source_type, $selected, array('class' => 'form-control select_box', 'style' => 'width:100%'));
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label"><?= lang('transfer_type') ?></label>

                                <div class="col-sm-4">
                                    <?php
                                    $transfer_type = array('send' => lang('send'), 'receive' => lang('receive'),);

                                    $selected = ($items_info->transfer_type) ? $items_info->transfer_type : '';
                                    echo form_dropdown('transfer_type', $transfer_type, $selected, array('class' => 'form-control select_box', 'style' => 'width:100%'));
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
