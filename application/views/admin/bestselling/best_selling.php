    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-custom">
            <header class="panel-heading ">
                <div class="panel-title"><strong><?= lang('best_selling_product') ?></strong></div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-custom">
                    <div class="panel-heading">
                        <div class="panel-title"><strong><?= lang('best_selling_product') ?></strong>
                        </div>
                    </div>
                    <div class="panel-body">
                ...
                <div class="panel panel-custom">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <div class="panel-title">
                                <strong><?= lang('worst_selling_product') ?></strong></div>
                        </div>
                    </div>
                    <div class="panel-body">
