...
<div class="row mb">
    <div class="col-sm-10">
        ...
        <a class="btn btn-xs btn-danger <?= $disable ?>" data-toggle="tooltip" data-placement="top" href="<?= $p_url ?>"
            title="<?= lang('add_payment') ?>"><i class="fa fa-credit-card"></i>
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu animated zoomIn">
                ...
                <li>
                    <a
                        href="<?= base_url() ?>admin/purchase/new_purchase/<?= $purchase_info->purchase_id ?>"><?= lang('edit') . ' ' . lang('purchase') ?></a>
                </li>
                <?php } ?>
            </ul>
            <?php } ?>
    ...
    <div class="col-sm-2 pull-right">
        ...
        <a href="<?= base_url() ?>admin/purchase/pdf_purchase/<?= $purchase_info->purchase_id ?>" data-toggle="tooltip"
            data-placement="top" title="" data-original-title="PDF" class="btn btn-xs btn-success pull-right mr-sm">
            <i class="fa fa-file-pdf-o"></i>
        </a>
        <?php if (!empty($can_edit) && !empty($edited)) { ?>
        <a href="<?= base_url() ?>admin/purchase/new_purchase/<?= $purchase_info->purchase_id ?>" data-toggle="tooltip"
            data-placement="top" title="" data-original-title="<?= lang('edit') ?>"
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-xs-12 ">
                <div class="pull-right pr-lg">
                    ...
                    <br><?= lang('sales_agent') ?>: <?php echo fullname($purchase_info->user_id); ?>
                    <?php }
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="<?= base_url() ?>admin/purchase/payments_details/<?= $v_payments_info->payments_id ?>">
                            <?= $v_payments_info->trans_id; ?></a>
                    </td>
                    <td>
                        <a
                            href="<?= base_url() ?>admin/purchase/payments_details/<?= $v_payments_info->payments_id ?>"><?= display_date($v_payments_info->payment_date); ?></a>
                    </td>
...
<ul class="pagination" style="float: right">
    ...
    $previous_payment=$this->db->where('purchase_id', ($purchase_info->purchase_id-1))->get('tbl_purchases')->row();
    if($previous_payment)
        $disable_previous_payment='';

    $next_payment=$this->db->where('purchase_id', ($purchase_info->purchase_id+1))->get('tbl_purchases')->row();
    if($next_payment)
        $disable_next_payment='';
    ?>
    <li class="paginate_button <?php echo $disable_previous_payment ?>">
        <a class="text-info" href="<?php echo base_url() . 'admin/purchase/purchase_details/' . ($purchase_info->purchase_id-1) ?>" > <?php echo lang('previous_payment')?> </a>
    </li>
    <li class="paginate_button <?php echo $disable_next_payment ?> "  >
        <a class="text-info" href="<?php echo base_url() . 'admin/purchase/purchase_details/' . ($purchase_info->purchase_id+1) ?>" > <?php echo lang('next_payment')?> </a>
    </li>
</ul>
